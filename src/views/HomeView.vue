					...
					<div class="ts-col">
						...
						<div v-for="s in topBuy" :key="s.id" class="ts-row" @click="openDetail(s)">
							...
							<div style="flex:1">
								...
								<div style="font-family:var(--mono);font-size:8px;color:var(--mu)">vor {{ ageLabel(s) }}
								</div>
							</div>
			...
			<div class="pad" style="margin-top:6px;padding-bottom:16px">
				...
				<div class="acc-block">
					<div class="acc-head" @click="accIndex = !accIndex">
						...
						<span class="acc-chg" style="color:var(--g)">S&P +8.2% · NQ +12.1% · DOW +6.4%</span>
				...
				<div class="acc-block" style="margin-top:8px">
					<div class="acc-head" @click="accSig = !accSig">
						<span class="acc-title">Signal-Verteilung (30 Tage)</span>
						<span class="acc-chg" style="color:var(--mu)">BUY 42% · HOLD 31% · SELL 27%</span>
				...
				<div class="acc-block" style="margin-top:8px">
					<div class="acc-head" @click="accSec = !accSec">
						<span class="acc-title">Sektoren-Performance</span>
						<span class="acc-chg" style="color:var(--mu)">8 Sektoren</span>
