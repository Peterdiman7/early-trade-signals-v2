	...
	<div class="drawer-ov" @click.self="$emit('close')">
		<div class="drawer open">
			...
			<div class="dr-profile" @click="$emit('close')">
				...
				<div style="margin-top:8px;font-size:9px;color:var(--mu);font-family:var(--mono)">Profil bearbeiten →
				</div>
			</div>
			...
			<div style="padding:4px 0">
				...
				<div class="dr-toggle-row" @click="appStore.toggleNotif()">
					...
					<span class="dr-toggle-label">{{ appStore.notifEnabled ? 'Benachrichtigungen an' :
						'Benachrichtigungen aus' }}</span>
					<label class="ios-toggle" @click.stop>
